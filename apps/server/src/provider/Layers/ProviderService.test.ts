...
describe("agent browser access", () => {
  ...
  const startSessionWith = (
    ...
    options?: {
      ...
      readonly kanban?: "none" | "read" | "write";
    },
  ) =>
    Effect.gen(function* () {
      ...
      const providerLayer = makeProviderServiceLive({
        ...
        Layer.provide(
          ServerSettings.ServerSettingsService.layerTest({
            ...
            enableAgentUsageAccess: options?.usage ?? false,
            enableAgentMeshAccess: options?.mesh ?? false,
            agentKanbanAccess: options?.kanban ?? "none",
  ...
  it.effect("combines the optional mesh, usage, and Kanban capabilities", () =>
    Effect.gen(function* () {
      const threadId = asThreadId("thread-optional-mcp-capabilities");
