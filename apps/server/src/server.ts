...
import * as AgentMesh from "./mcp/AgentMesh.ts";
...
import * as KanbanDelegationReactor from "./orchestration/KanbanDelegationReactor.ts";
...
export const makeRoutesLayer = Layer.mergeAll(
  ...
  McpHttpServer.layer.pipe(Layer.provide(AgentMesh.layer), Layer.provide(McpSessionRegistry.layer)),
).pipe(
