...
const decodeMcpToolJsonSchema = Schema.decodeUnknownSync(McpSchema.ToolJsonSchema);
const mcpInputSchema = (schema: JsonSchema.JsonSchema): McpSchema.ToolJsonSchema =>
  decodeMcpToolJsonSchema({ ...schema, type: "object" });
...
export const PullRequestsToolkitRegistrationLive = registerMcpToolkit(PullRequestsToolkit).pipe(
  Layer.provide(PullRequestsToolkitHandlersLive),
);

const DeviceStandardToolkitRegistrationLive = registerMcpToolkit(DeviceStandardToolkit).pipe(
