...
import { BotProfile, ModelSelection, ThreadLinkedPullRequest } from "@t3tools/contracts";
    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.botProfile == null ? null : JSON.stringify(row.botProfile)},
    ...
    execute: ({ threadId }) =>
      sql`
        SELECT
          ...
          bot_profile_json AS "botProfile",
