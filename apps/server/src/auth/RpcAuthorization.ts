...
export const RPC_REQUIRED_SCOPES = {
  ...
  [ORCHESTRATION_WS_METHODS.listSchedules]: AuthOrchestrationReadScope,
  [ORCHESTRATION_WS_METHODS.listPages]: AuthOrchestrationReadScope,
  [ORCHESTRATION_WS_METHODS.getPage]: AuthOrchestrationReadScope,
  [ORCHESTRATION_WS_METHODS.getPageContent]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.serverGetSkillStore]: AuthOrchestrationReadScope,
  [WS_METHODS.serverMutateSkillStore]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverGetUsageSummary]: AuthOrchestrationReadScope,
  [WS_METHODS.serverGetSubscriptionQuota]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.kanbanSubscribeBoard]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.botComputerInspect]: AuthOrchestrationReadScope,
  [WS_METHODS.botComputerViewerAccess]: AuthOrchestrationOperateScope,
  [WS_METHODS.botComputerStart]: AuthOrchestrationOperateScope,
  [WS_METHODS.botComputerSuspend]: AuthOrchestrationOperateScope,
  [WS_METHODS.botComputerResume]: AuthOrchestrationOperateScope,
  [WS_METHODS.botComputerReset]: AuthOrchestrationOperateScope,
  [WS_METHODS.botComputerDestroy]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.skillStoreSearch]: AuthOrchestrationReadScope,
  [WS_METHODS.skillStoreGetDetail]: AuthOrchestrationReadScope,
  [WS_METHODS.skillStoreListInstalled]: AuthOrchestrationReadScope,
  [WS_METHODS.skillStoreInstall]: AuthOrchestrationOperateScope,
  [WS_METHODS.skillStoreUninstall]: AuthOrchestrationOperateScope,
  [WS_METHODS.skillStoreSetHarnessEnabled]: AuthOrchestrationOperateScope,
