...
const VARIANT_CONFIG = {
  development: {
    appName: "ConvergeOS Dev",
    scheme: ["convergeos-dev", "t3code-dev"],
    iosBundleIdentifier: "com.convergeos.app.dev",
    androidPackage: "com.convergeos.app.dev",
    relyingParty: "clerk.t3.codes",
    assets: DEVELOPMENT_ASSETS,
  },
  preview: {
    appName: "ConvergeOS Preview",
    scheme: ["convergeos-preview", "t3code-preview"],
    iosBundleIdentifier: "com.convergeos.app.preview",
    androidPackage: "com.convergeos.app.preview",
    relyingParty: "clerk.t3.codes",
    assets: PREVIEW_ASSETS,
  },
  production: {
    appName: "ConvergeOS",
    scheme: ["convergeos", "t3code"],
    iosBundleIdentifier: "com.convergeos.app",
    androidPackage: "com.convergeos.app",
    relyingParty: "clerk.t3.codes",
    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active ConvergeOS agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow ConvergeOS to connect to ConvergeOS servers on your local network or tailnet.",
      NSPhotoLibraryAddUsageDescription: "Allow ConvergeOS to save images to your photo library.",
  ...
  plugins: [
    ...
    [
      "expo-audio",
      {
        microphonePermission: "Allow ConvergeOS to use your microphone for voice input.",
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow ConvergeOS to access your camera so you can scan pairing QR codes.",
