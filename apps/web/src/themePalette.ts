...
/**
 * The palette ConvergeOS wears with no theme installed, captured from the app's
...
/**
 * The standard ConvergeOS look as a theme palette, for seeding a new theme when
...
/**
 * The status colors ConvergeOS shows without a theme, read from the app's own
