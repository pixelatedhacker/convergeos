...
const makeDesktopClerkLayer = (isDevelopment = true, events: string[] = []) => {
  const environment = DesktopEnvironment.DesktopEnvironment.of({
    ...
    userDataDirName: isDevelopment ? "convergeos-dev" : "convergeos",
    legacyUserDataDirName: isDevelopment ? "ConvergeOS (Dev)" : "ConvergeOS (Alpha)",
...
describe("DesktopClerk", () => {
  ...
  it.effect("acquires and releases the SDK bridge with the layer", () => {
    ...
    return Effect.gen(function* () {
        ...
        [
          {
            ...
            passkeys: true,
            renderer: { scheme: "convergeos-dev", host: "app" },
          },
        ],
      ]);
      ...
      assert.deepEqual(events, [
        "setPath:userData:/tmp/app-data/convergeos-dev",
        "createClerkBridge",
      ]);
  ...
  it.each([
    { isDevelopment: true, scheme: "convergeos-dev" },
    { isDevelopment: false, scheme: "convergeos" },
