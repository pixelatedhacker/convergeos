...
const APP_BASE_NAME = "ConvergeOS";
...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const userDataDirName = isDevelopment ? "convergeos-dev" : "convergeos";
  ...
  return DesktopEnvironment.of({
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "com.convergeos.app.dev" : "com.convergeos.app",
    ),
    linuxDesktopEntryName: isDevelopment ? "convergeos-dev.desktop" : "convergeos.desktop",
    linuxWmClass: isDevelopment ? "convergeos-dev" : "convergeos",
