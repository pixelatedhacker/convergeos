...
const EXTENSION = "org.gnome.Shell.Extensions.ConvergeOSSnapShot";
const EXTENSION_PATH = "/org/gnome/Shell/Extensions/ConvergeOSSnapShot";
...
export class LinuxCaptureConnection {
  ...
  async captureExtension(appId: string, options?: FeedbackOptions): Promise<LinuxWindowSnapshot> {
    ...
    if (result !== RequestNameReply.PRIMARY_OWNER) {
      throw new Error("Another ConvergeOS instance is capturing a window. Try again.");
    }
