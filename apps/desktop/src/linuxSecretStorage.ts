...
function getGnomeKeyringRemediationMessage(): string {
  return "ConvergeOS could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart ConvergeOS.";
}

function getKWalletRemediationMessage(): string {
  return "ConvergeOS could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart ConvergeOS.";
}
