...
const NAME = "org.gnome.Shell.Extensions.ConvergeOSSnapShot";
const PATH = "/org/gnome/Shell/Extensions/ConvergeOSSnapShot";
...
function takeSnapshot(animate) {
  ...
  if (animate && St.Settings.get().enable_animations) {
    try {
      ...
      console.warn(`ConvergeOS capture preview unavailable: ${error.message}`);
    }
  }
...
export default class ConvergeOSSnapShotExtension extends Extension {
  enable() {
