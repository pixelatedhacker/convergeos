...
export const SkillStoreScope = Schema.Literals(["global", "project"]);
export type SkillStoreScope = typeof SkillStoreScope.Type;
...
export const SkillStoreErrorReason = Schema.Literals([
  "registryUnavailable",
  "cliUnavailable",
  "installFailed",
  "removeFailed",
...
export type SkillStoreErrorReason = typeof SkillStoreErrorReason.Type;

export class SkillStoreError extends Schema.TaggedErrorClass<SkillStoreError>()(
  "SkillStoreError",
  {
    reason: SkillStoreErrorReason,
