  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new ConvergeOS prerelease is available for nightly testers."
          : "A new ConvergeOS latest release is available.",
...
).pipe(Command.withDescription("Post a ConvergeOS release announcement to Discord."));
