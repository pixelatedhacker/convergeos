...
- [Run prompts on a schedule](./user/schedules.md)
- [Product usage data](./user/telemetry.md)
- [Remote access](./user/remote-access.md)
- [Running in the background](./user/background-service.md)
- [Updating ConvergeOS](./user/updating.md)
- Provider guides: [Codex](./user/providers-codex.md) · [Claude](./user/providers-claude.md) · [OpenCode](./user/providers-opencode.md) · [Antigravity](./user/providers-antigravity.md) · [Oh My Pi](./user/providers-oh-my-pi.md)
- [Skills and plugins](./user/skills-and-plugins.md)

---

## Working on ConvergeOS
...
- [Kanban](./internals/kanban.md)
- [Worktree inventory](./internals/worktrees.md)
- [Schedules](./internals/schedules.md)
