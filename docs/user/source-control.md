...
ConvergeOS integrates with GitHub, GitLab, Forgejo, Gitea, Bitbucket, and Azure DevOps to clone and publish
repositories, create pull requests, and review changes.

## Connect an account

Install Git and configure authentication on the machine running your ConvergeOS server. For a remote
...
Use a thread's Git actions to commit, push, and create a pull request. ConvergeOS can generate commit
