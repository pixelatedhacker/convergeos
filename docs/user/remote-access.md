...
Connect a phone, browser, or another desktop app to ConvergeOS running on a different
...
**SSH**, and enter a host or SSH alias such as `user@example.com`. ConvergeOS starts
...
the connection stops a server that ConvergeOS launched; a server that was already
...
| Error                                                     | Recovery                                                                                                                                    |
| --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| `environment_link_limit_exceeded` or managed tunnel limit | Deregister an unused environment, then restart ConvergeOS on the host.                                                                         |
...
| Expired or invalid link proof                             | Check the host's date and time, update ConvergeOS, then restart it.                                                                            |
...
devices. For server version warnings, follow [Updating ConvergeOS](./updating.md).
...
environment**. ConvergeOS restarts without a local server: no local agents or terminals run, WSL
