...
When you change a new thread's project, ConvergeOS stays in the current environment
...
If dragging is unavailable for one environment, update the ConvergeOS server running in that
