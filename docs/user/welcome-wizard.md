...
- **This computer** runs agents on the computer that hosts ConvergeOS. It does not
  require an account.
...
ConvergeOS checks the selected computer for Claude Code and Codex. If an agent is
...
ConvergeOS finds directories that Claude Code or Codex has used. The default
