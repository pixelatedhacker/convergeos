...
- `CONVERGEOS_WEB_ROUTER_URL`: defaults to `https://app.t3.codes`.
- `CONVERGEOS_WEB_LATEST_DOMAIN`: defaults to `latest.app.t3.codes`.
- `CONVERGEOS_WEB_NIGHTLY_DOMAIN`: defaults to `nightly.app.t3.codes`.
...
- Repository slug source:
  - `CONVERGEOS_DESKTOP_UPDATE_REPOSITORY` (format `owner/repo`), if set.
